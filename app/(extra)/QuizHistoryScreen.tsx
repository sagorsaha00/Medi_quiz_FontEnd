    ...
    <View style={styles.container}>
      <LinearGradient colors={['#111827', '#1f2937']} style={styles.header}>
        <View style={styles.headerRow}>
          <Text style={styles.headerTitle}>Your Quiz History</Text>
          <Ionicons name="time-outline" size={22} color="#cbd5e1" />
        </View>
        <View style={styles.statsRow}>
          ...
          <View style={styles.statCard}>
            ...
            <Text style={styles.statValue}>{overall.correct}</Text>
          </View>
          <View style={styles.statCard}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          ...
          const wrongPct = percent(item.wrongAnswers, item.totalQuestions);
           ...
           <>
            <Pressable style={styles.card}>
              ...
              <View style={styles.progressRow}>
                ...
                <Text style={styles.progressLabel}>{correctPct}%</Text>
              </View>
