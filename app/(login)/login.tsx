      ...
      >
        <View style={styles.rightContainer}>
          <View style={styles.loginCard}>
            ...
            {/* Sign Up Link */}
            <Text onPress={() => router.push('/register')} style={styles.signupText}>
...
const styles = StyleSheet.create({
  ...
  loginTitle: { fontSize: 32, fontWeight: '800', color: '#333', marginBottom: 8 },
  ...
  eyeIcon: { padding: 4 },
  errorText: { color: '#e11d48', fontSize: 13, marginBottom: 8, marginLeft: 8 },
  forgot: { alignSelf: 'flex-end', color: '#667eea', marginBottom: 24, fontSize: 14, fontWeight: '500' },
  loginBtn: {
    width: '100%',
    borderRadius: 16,
    marginBottom: 20,
